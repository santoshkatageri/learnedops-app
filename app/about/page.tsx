    ...
    <main className="py-20">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <article className="prose prose-neutral prose-invert max-w-3xl mt-10">
          ...
          <blockquote>
            <p>Better systems come from better decisions, not more tools.</p>
          </blockquote>
          ...
          <p>
            LearnedOps is maintained by an engineer working with real production
            systems. It is not a course platform or a consulting pitch — just a
            long-term thinking space, built in public.
          </p>
        </article>
      </div>
    </main>
